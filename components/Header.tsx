  ...
  return (
    <header className="bg-white border-b border-slate-200 sticky top-0 z-30">
      ...
      {menuOpen ? (
        ...
        >
          <div
            className="absolute top-0 left-0 h-full w-[82%] max-w-xs bg-white shadow-xl p-4 flex flex-col gap-1"
          ...
          >
            ...
            {navLinks.map((l) => (
              <Link
                ...
                href={l.href}
                onClick={() => setMenuOpen(false)}
                className="px-3 py-3 rounded-lg text-slate-800 hover:bg-slate-100 text-base"
              >
                {t(l.key)}
              </Link>
            ))}
            ...
            <Link
              href="/about"
              onClick={() => setMenuOpen(false)}
              className="px-3 py-3 rounded-lg text-slate-600 hover:bg-slate-100 text-sm"
            >
              {t("footer.about")}
            </Link>
          </div>
